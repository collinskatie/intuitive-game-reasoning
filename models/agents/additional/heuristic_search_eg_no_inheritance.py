...
def make_move(
    ...
    return action, action_dist, pv_depth, ave_depth, actual_num_steps_run, 0
...
def act(
    ...
    action, action_distribution, pv_depth, ave_depth, actual_num_steps_run, _ = (
        make_move(
            board,
